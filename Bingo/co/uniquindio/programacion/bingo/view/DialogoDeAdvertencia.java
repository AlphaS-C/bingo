 ...
 *
 * Esta clase DialogoDeAdvertencia tiene como responsabilidad mostrar un dialogo de advertencia.
 */
public class DialogoDeAdvertencia extends Dialogo 
{

	/**
	 * Método constructor de la clase DialogoDeAdvertencia, su responsabilidad es 
	...
	/**
	 * Método publico que permite mostrar el mensaje especificado en el dialogo.
	 *
	 * @return un entero que determina que bóton presionó (Aceptar o Cancelar).
	 */
